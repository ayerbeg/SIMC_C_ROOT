...
int main() {
    std::cout << "==========================================\n";
    std::cout << "  HRSr Standalone Transport Test\n";
    std::cout << "==========================================\n\n";
    
    // Initialize HRSr
    HRSr hrsr;
    
    std::cout << "Loading HRSr matrix files...\n";
    if (!hrsr.LoadMatrices("../data/matrices/hrsr/hrs_forward_cosy.dat",
                           "../data/matrices/hrsr/hrs_recon_cosy.dat")) {
        std::cerr << "ERROR: Failed to load matrix files!\n";
        return 1;
    }
    std::cout << "HRSr initialized successfully.\n\n";
    ...
    for (const auto& config : configs) {
        ...
        for (int i = 0; i < config.nevents; ++i) {
            ...
            if (hrsr.Transport(track)) {
                ++accepted;
            }
        }
        
        auto stats = hrsr.GetStats();
        ...
        std::cout << "  Acceptance:  " << std::fixed << std::setprecision(1) 
                  << acceptance << "%\n";
        std::cout << "\nRejection Breakdown:\n";
        std::cout << "  Collimator:    " << stats.rSTOP_slit << "\n";
        std::cout << "  Q1 entrance:   " << stats.rSTOP_Q1_in << "\n";
        std::cout << "  Q1 mid:        " << stats.rSTOP_Q1_mid << "\n";
        std::cout << "  Q1 exit:       " << stats.rSTOP_Q1_out << "\n";
        std::cout << "  Q2 entrance:   " << stats.rSTOP_Q2_in << "\n";
        std::cout << "  Q2 mid:        " << stats.rSTOP_Q2_mid << "\n";
        std::cout << "  Q2 exit:       " << stats.rSTOP_Q2_out << "\n";
        std::cout << "  D1 entrance:   " << stats.rSTOP_D1_in << "\n";
        std::cout << "  D1 exit:       " << stats.rSTOP_D1_out << "\n";
        std::cout << "  Q3 entrance:   " << stats.rSTOP_Q3_in << "\n";
        std::cout << "  Q3 mid:        " << stats.rSTOP_Q3_mid << "\n";
        std::cout << "  Q3 exit:       " << stats.rSTOP_Q3_out << "\n";
        std::cout << "  Made to hut:   " << stats.rSTOP_hut << "\n";
        std::cout << "\n";
    }
    
    std::cout << "==========================================\n";
    std::cout << "HRSr Standalone Test Complete!\n";
    std::cout << "==========================================\n\n";
