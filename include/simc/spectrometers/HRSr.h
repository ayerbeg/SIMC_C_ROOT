...
// Hall A Right HRS Spectrometer - Phase 5c.6
...
/**
 * @brief Hall A Right High Resolution Spectrometer (HRSr)
 * 
...
public:
    ...
    /**
     * @brief Transport statistics (matches Fortran rSTOP_* counters)
     */
    struct TransportStats {
        int rSTOP_trials{0};
        int rSTOP_successes{0};
        int rSTOP_slit{0};         // Collimator rejections
        int rSTOP_Q1_in{0};
        int rSTOP_Q1_mid{0};
        int rSTOP_Q1_out{0};
        int rSTOP_Q2_in{0};
